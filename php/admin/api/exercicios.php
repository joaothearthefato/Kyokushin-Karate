...
switch ($method) {
    ...
    case 'POST':
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            echo json_encode(['success' => false, 'error' => 'Erro ao cadastrar exercício: ' . mysqli_error($conn)]);
        }
        break;
    ...
    case 'PUT':
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            http_response_code(500);
            echo json_encode(['success' => false, 'error' => 'Erro ao atualizar exercício: ' . mysqli_error($conn)]);
        }
        break;
    ...
    case 'DELETE':
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            http_response_code(500);
            echo json_encode(['success' => false, 'error' => 'Erro ao excluir exercício: ' . mysqli_error($conn)]);
        }
        break;
